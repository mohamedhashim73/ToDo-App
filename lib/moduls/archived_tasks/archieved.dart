  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit,AppStates>(
      ...
      builder: (context,state){
        ...
        return
          _cubit.archivedtasks.isEmpty? Center(child:  Icon(Icons.archive_outlined,size: 35,color: Colors.grey,)) :
          Container(
            ...
            child: ListView.separated(
              itemBuilder: (context,i){
                return Dismissible(
                  ...
                  {
                    _cubit.DeleteDatebase(id: _cubit.archivedtasks[i]['id']);
                  ...
                  child: GestureDetector(
                    ...
                    {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>TaskBodyScreen(text: '${_cubit.archivedtasks[i]['title']}',)));
                    },
                    child: Container(
                        ...
                        [
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              maxRadius: 30,
                              child:Text("${_cubit.archivedtasks[i]['time']}",style: TextStyle(fontSize: 10),),
                            ),
                          ),
                                ...
                                [
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Text("${_cubit.archivedtasks[i]['title']}",
                                    ...
                                    [
                                      Row(
                                        children: [
                                          ...
                                          Text("${_cubit.archivedtasks[i]['date']}",style: dateStyle,),
                                        ],
                                      ),
                                      IconButton(
                                        icon: Icon(Icons.delete,color: secondColor,size: 22,),
                                        onPressed: (){
                                          _cubit.DeleteDatebase(id: _cubit.archivedtasks[i]['id']);
                                          snackBar = const SnackBar(content: Text("Deleted successfully"),duration: Duration(microseconds: 2),);
                                          ScaffoldMessenger.of(context).showSnackBar(snackBar);
